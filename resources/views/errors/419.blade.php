            ...
            <div class="mx-auto max-w-2xl py-16">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                        Page expired <a href="{{ route('dashboard') }}" class="font-semibold text-indigo-600 no-underline"><span class="absolute inset-0" aria-hidden="true"></span>Back to Home <span aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Page Expired</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Page was open for too long so page expired to secure the session from hackers who use CSRF tokens.</p>
