<x-admin-layout toastify="1">
    <div class="max-w-screen-xl mx-auto px-4 mb-8">
        ...
        <form action="{{ route('sender-numbers.store') }}" method="post" data-js="app-form">
            <div class="flex flex-wrap -mx-1">
                <div class="w-full sm:w-6/12 px-1 mb-2">
                    <div class="flex flex-col">
                        <span>Phone</span>
                        <input type="number" name="phone" value="" class="rounded focus:border-primary-500 focus:ring-primary-400" />
                    </div>
                ...
                <div class="w-full px-1">
                    ...
                    <x-button type="submit" data-js="app-form-btn">Create Sender Number</x-button>
                </div>
            </div>
        </form>
    </div>
